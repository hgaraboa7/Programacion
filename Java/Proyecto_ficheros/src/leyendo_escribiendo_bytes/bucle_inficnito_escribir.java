...
public class bucle_inficnito_escribir {
		...
		static void crea_fichero(int datos_nuevo_fichero[]) {
			...
			try {
				...
				FileOutputStream fichero_nuevo;
				while(contador2!=10) {
				
				fichero_nuevo=new FileOutputStream("ficheros1/BinLaden_copia"+contador2+".webp");
				...
				System.out.println("copia" +contador2+ "realizada");
